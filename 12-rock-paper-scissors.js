...
// in the autoplay fxn it's better it doesn't use arrow function because, it looks easier that way and it allows hoisting
//const autoPlay = () => {
...
document.body.addEventListener('keydown', (event) => {
  ...
  function displayResetConfirmation() {
    document.querySelector('.js-reset-confirmation')
      ...
      <button class="js-reset-button js-reset-yes-button">Yes</button>
      <button class="js-reset-button js-reset-no-button">No</button>`;
